...
public:
	...
	// std::vector <Ysec3> MakeNACA4DigitAirfoil(int naca,const double dz);
};
...
/* virtual */ void FsLazyWindowApplication::Initialize(int argc,char *argv[])
{
	...
	// 	test[i].Get(x_temp, y_temp, z_temp);
	// 	//vtx.push_back(x_temp);
	// 	// vtx.push_back(y_temp);
	// 	// vtx.push_back(z_temp);
	// 	cout << "x: " << x_temp << " y: " << y_temp << " z: " << z_temp << endl; 		
	// }
	//vtx.push_back(x_temp);
	// int answer1 = vtx.size();
	// printf(" \n vertices = %d", answer1);
